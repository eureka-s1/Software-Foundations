...
(** **** Exercise: 3 stars, standard, especially useful (bag_more_functions)
...
Fixpoint included (s1 : bag) (s2 : bag) : bool := 
  ...
  | nil, _ => true
  | _, nil => false
  | h1 :: t1, h2 :: t2 => if member h1 s2 then included t1 (remove_one h1 s2) else false
  end.
...
Theorem add_inc_count : forall (n : nat) (l : bag), count n (add n l) = S (count n l).
Proof.
...
Theorem bag_count_sum : forall (s1 s2 : bag) (a : nat), 
...
(** use [destruct] to match arbitrarily expressions. *)
